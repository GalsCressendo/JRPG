...
namespace PixelCrushers.QuestMachine
{
    ...
    public class UnityUIFoldoutTemplate : UnityUIContentTemplate
    {
        ...
        {
            base.Retire();
            foldoutButton.onClick.RemoveAllListeners();
        }
