...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestGiver : IdentifiableQuestListContainer
    {
        ...
        {
            base.OnEnable();
            if (cooldownCheckFrequency > 0) InvokeRepeating(nameof(UpdateCooldowns), cooldownCheckFrequency, cooldownCheckFrequency);
        }
        ...
        protected virtual void RecordOfferableQuests()
        {
            ...
            for (int i = 0; i < questList.Count; i++)
            {
                ...
                if (quest.canOffer && quest.RecheckOfferConditions() &&
                    !isPlayerCopyActive && (playerCopy == null || playerCopy.timesAccepted < quest.maxTimes))
                {
        ...
        public virtual GameObject FindPlayerJournalGameObject()
        {
            ...
            var journal = PixelCrushers.GameObjectUtility.FindFirstObjectByType<QuestJournal>(); // In case designer forgot to tag player as Player.
        ...
        public virtual GameObject FindPlayerGameObject()
        {
            ...
            var journal = PixelCrushers.GameObjectUtility.FindFirstObjectByType<QuestJournal>(); // In case designer forgot to tag player as Player, find a QuestJournal.
            return (journal != null) ? journal.gameObject : null;
        }
