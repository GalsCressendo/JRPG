    ...
    public class WelcomeWindow : EditorWindow
    {
        ...
        private void DrawButtons()
        {
            ...
            try
            {
                ...
                try
                {
                    if (GUILayout.Button(new GUIContent("Manual", "Open the Quest Machine manual."), quickButtonGuiStyle, GUILayout.Width(ButtonWidth), ButtonHeightLayout))
                    {
                    ...
                    if (GUILayout.Button(new GUIContent("Videos", "Open the video tutorial list."), quickButtonGuiStyle, GUILayout.Width(ButtonWidth), ButtonHeightLayout))
                    {
                        Application.OpenURL("https://www.pixelcrushers.com/quest-machine-video-tutorials/");
                    }
                    if (GUILayout.Button(new GUIContent("Scripting\nReference", "Open the scripting & API reference."), quickButtonGuiStyle, GUILayout.Width(ButtonWidth), ButtonHeightLayout))
                    {
                        Application.OpenURL("https://pixelcrushers.com/quest_machine/api/html");
                    }
                ...
                try
                {
                    if (GUILayout.Button(new GUIContent("Quest\nEditor", "Open the Quest Editor."), quickButtonGuiStyle, GUILayout.Width(ButtonWidth), ButtonHeightLayout))
                    {
                        QuestEditorWindow.ShowWindow();
                    }
                    if (GUILayout.Button(new GUIContent("Quest\nGenerator", "Open the Quest Generator Editor."), quickButtonGuiStyle, GUILayout.Width(ButtonWidth), ButtonHeightLayout))
                    {
                        QuestGeneratorEditorWindow.ShowWindow();
                    }
                    if (GUILayout.Button(new GUIContent("Quest\nReference", "Open the Quest Reference utility window."), quickButtonGuiStyle, GUILayout.Width(ButtonWidth), ButtonHeightLayout))
                    {
                        QuestReferenceEditorWindow.ShowWindow();
                    }
                    if (GUILayout.Button(new GUIContent("Text\nTable\nEditor", "Open the Text Table editor."), quickButtonGuiStyle, GUILayout.Width(ButtonWidth), ButtonHeightLayout))
                    {
