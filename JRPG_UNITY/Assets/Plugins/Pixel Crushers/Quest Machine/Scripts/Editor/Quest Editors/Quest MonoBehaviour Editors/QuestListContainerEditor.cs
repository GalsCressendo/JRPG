...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestListContainerEditor : UnityEditor.Editor
    {
        ...
        protected virtual void DrawSaveSettings()
        {
            ...
            {
                QuestEditorUtility.EditorGUILayoutBeginGroup();
                var includeInSavedGameDataProperty = serializedObject.FindProperty("m_includeInSavedGameData");
                EditorGUILayout.PropertyField(includeInSavedGameDataProperty);
                if (includeInSavedGameDataProperty.boolValue)
                {
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("m_saveQuestsToJson"));
