...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestConditionSetInspectorGUI
    {
        ...
        private SerializedProperty m_conditionSetProperty;
        ...
        public void Draw(SerializedProperty conditionSetProperty)
        {
            ...
            m_conditionSetProperty = conditionSetProperty;
        ...
        private void OnDrawHeader(Rect rect)
        {
            ...
            var label = "Conditions";
            if (Application.isPlaying)
            {
                var numTrueConditions = m_conditionSetProperty.FindPropertyRelative("m_numTrueConditions").intValue;
                label = $"Conditions ({numTrueConditions} true)";
            }
        ...
        private void OnAddDropdown(Rect buttonRect, ReorderableList list)
        {
            ...
            for (int i = 0; i < subtypes.Count; i++)
            {
                ...
                var menuName = QuestEditorUtility.FullClassNameToMenuName(subtype.FullName);
                menu.AddItem(new GUIContent(ObjectNames.NicifyVariableName(menuName).Replace("Quest Condition", string.Empty)), false, OnAddQuestConditionType, subtype);
            }
            menu.ShowAsContext();
        }
