...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestContentListInspectorGUI
    {
        ...
        private void OnDrawElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            EditorGUI.LabelField(rect, content.GetEditorName().Replace("\n", "\\n"));
        }
        ...
        private void OnAddDropdown(Rect buttonRect, ReorderableList list)
        {
            ...
            for (int i = 0; i < subtypes.Count; i++)
            {
                ...
                menu.AddItem(new GUIContent(ObjectNames.NicifyVariableName(menuName).Replace("Quest Content", string.Empty)), false, OnAddQuestContentType, subtype);
            }
            menu.ShowAsContext();
        }
