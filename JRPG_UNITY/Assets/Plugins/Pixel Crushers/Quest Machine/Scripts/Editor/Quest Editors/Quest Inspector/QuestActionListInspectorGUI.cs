...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestActionListInspectorGUI
    {
        ...
        private void OnDrawElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            EditorGUI.LabelField(rect, questAction.GetEditorName().Replace("\n", "\\n"));
        }
        ...
        private void OnAddDropdown(Rect buttonRect, ReorderableList list)
        {
            ...
            for (int i = 0; i < subtypes.Count; i++)
            {
                ...
                menu.AddItem(new GUIContent(ObjectNames.NicifyVariableName(menuName).Replace("Quest Action", string.Empty)), false, OnAddQuestActionType, subtype);
            }
            menu.ShowAsContext();
        }
