...
namespace PixelCrushers.QuestMachine
{
    ...
    public class Quest : ScriptableObject
    {
        ...
        [Tooltip("Clear all associated quest indicators when quest becomes inactive (e.g., successful).")]
        [SerializeField]
        private bool m_clearIndicatorsWhenComplete = true;
        ...
        /// <summary>
        /// Clear all associated quest indicators when quest becomes inactive (e.g., successful).
        /// </summary>
        public bool clearIndicatorsWhenComplete
        {
            get { return m_clearIndicatorsWhenComplete; }
            set { m_clearIndicatorsWhenComplete = value; }
        }
        ...
        public void Initialize()
        {
            ...
            var instanceID = EntityUtility.GetEntityInt(this);
        ...
        public bool RecheckOfferConditions()
        {
            // Allow condition set to update conditions first.
            return offerConditionSet.RecheckConditions() && canOffer;
        }
        ...
        public void SetState(QuestState newState, bool informListeners = true)
        {
            ...
            if (m_state != QuestState.Active && clearIndicatorsWhenComplete) ClearQuestIndicatorStates();
