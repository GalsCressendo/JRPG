...
namespace PixelCrushers.QuestMachine
{
    ...
    public static class QuestMachine
    {
        ...
        public static bool isQuitting => QuestMachineConfiguration.isQuitting;
        ...
        public static QuestJournal GetQuestJournal(string id)
        {
            ...
            return PixelCrushers.GameObjectUtility.FindFirstObjectByType<QuestJournal>();
        }
        ...
        private static string GetQuestKey(Quest quest)
        {
            ...
            return StringField.IsNullOrEmpty(quest.id) ? EntityUtility.GetEntityInt(quest).ToString() : StringField.GetStringValue(quest.id);
        }
